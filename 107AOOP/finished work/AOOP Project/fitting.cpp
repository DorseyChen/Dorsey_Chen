...
fitting::fitting(unsigned basis_cnt,QStringList basis_list, string str,Ui::MainWindow*ui,bool& basis_error,type state)throw(const char*):graphics (str,ui,state),data_points(ui)
{
    basis_error=false;
    try {
        getpoints();
